...
public class TerrainBufferBuilder implements VertexConsumer {
    ...
    public void vertex(float x, float y, float z, int color, float u, float v, int light, int packedNormal) {
        this.vertex(x, y, z, color, u, v, light, packedNormal, 0);
    }

    public void vertex(float x, float y, float z, int color, float u, float v, int light, int packedNormal, int waving) {
        final long ptr = this.bufferPtr + this.nextElementByte;
        this.vertexBuilder.vertex(ptr, x, y, z, color, u, v, light, packedNormal, waving);
        this.endVertex();
    }
	...
	public VertexConsumer addVertex(float x, float y, float z) {
        ...
        this.vertexBuilder.waving(this.elementPtr, 0);
