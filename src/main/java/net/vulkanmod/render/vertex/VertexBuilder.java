...
public interface VertexBuilder {
    void vertex(long ptr, float x, float y, float z, int color, float u, float v, int light, int packedNormal, int waving);
    ...
    void waving(long ptr, int waving);
    ...
    class DefaultVertexBuilder implements VertexBuilder {
        ...
        public void vertex(long ptr, float x, float y, float z, int color, float u, float v, int light, int packedNormal, int waving) {
        ...
        @Override
        public void waving(long ptr, int waving) {
    ...
    class CompressedVertexBuilder implements VertexBuilder {
        ...
        public void vertex(long ptr, float x, float y, float z, int color, float u, float v, int light, int packedNormal, int waving) {
            ...
            MemoryUtil.memPutInt(ptr + 12, color);
            MemoryUtil.memPutInt(ptr + 16, waving);
        }
