...
public class Config {
    ...
    public boolean fsrEnabled = false;
    public int fsrInternalScale = 67;
    public int fsrSharpness = 20;
    public int terrainShadowQuality = 0;
    public int terrainLightingQuality = 0;
    public int skyQuality = 3;
    public int waterQuality = 0;
    public int volumetricResolutionScale = 1;
    ...
    public float pbrNormalStrength = 1.0f;
    public float pbrSpecularStrength = 1.0f;
    public boolean pomEnabled = false;
    public float pomHeightScale = 0.05f;
